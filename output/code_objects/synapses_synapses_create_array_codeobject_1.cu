...
void _run_synapses_synapses_create_array_codeobject_1()
{
...
int32_t* __restrict  _ptr_array_synapses_sources_1 = _array_synapses_sources_1;
int32_t* __restrict  _ptr_array_synapses_targets_1 = _array_synapses_targets_1;


for (int _idx=0; _idx<_numsources; _idx++) {
        
    const int32_t sources = _ptr_array_synapses_sources_1[_idx];
    const int32_t targets = _ptr_array_synapses_targets_1[_idx];
