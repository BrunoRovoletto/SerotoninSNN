#include "code_objects/synapses_8_summed_variable_Iinh_post_codeobject_2.h"
#include "objects.h"
...
__global__ void
_run_kernel_synapses_8_summed_variable_Iinh_post_codeobject_2(
    int _N,
...
void _run_synapses_8_summed_variable_Iinh_post_codeobject_2()
{
    using namespace brian;
    ...
    if (first_run)
    {
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxPotentialBlockSize(&min_num_threads, &num_threads,
                    _run_kernel_synapses_8_summed_variable_Iinh_post_codeobject_2, 0, 0)  // last args: dynamicSMemSize, blockSizeLimit
                );
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxActiveBlocksPerMultiprocessor(&max_active_blocks,
                    _run_kernel_synapses_8_summed_variable_Iinh_post_codeobject_2, num_threads, needed_shared_memory)
                );
        ...
        CUDA_SAFE_CALL(
                cudaFuncGetAttributes(&funcAttrib, _run_kernel_synapses_8_summed_variable_Iinh_post_codeobject_2)
                );
        ...
        {
            printf("INFO _run_kernel_synapses_8_summed_variable_Iinh_post_codeobject_2\n"
                   "\t%u blocks\n"
                   "\t%u threads\n"
...
CUDA_SAFE_CALL(
    ...
    _run_kernel_synapses_8_summed_variable_Iinh_post_codeobject_2<<<num_blocks, num_threads>>>(
            _N,
            num_threads,
            ///// HOST_PARAMETERS /////
    ...
    CUDA_CHECK_ERROR("_run_kernel_synapses_8_summed_variable_Iinh_post_codeobject_2");
