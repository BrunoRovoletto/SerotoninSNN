#include "code_objects/neurongroup_8_stateupdater_codeobject_6.h"
#include "objects.h"
...
__global__ void
_run_kernel_neurongroup_8_stateupdater_codeobject_6(
    int _N,
    int THREADS_PER_BLOCK,
    ///// KERNEL_PARAMETERS /////
    double* _ptr_array_neurongroup_8_A,
	double* _ptr_array_neurongroup_8_Iexc,
	double* _ptr_array_neurongroup_8_Iinh,
	double* _ptr_array_neurongroup_8_X,
	double* _ptr_array_neurongroup_8_Y,
	const double _value_array_defaultclock_dt,
	double* _ptr_array_neurongroup_8_v
    )
{
...

    {
        ...
        const double Iexc = _ptr_array_neurongroup_8_Iexc[_idx];
        const double Iinh = _ptr_array_neurongroup_8_Iinh[_idx];
        double X = _ptr_array_neurongroup_8_X[_idx];
        double Y = _ptr_array_neurongroup_8_Y[_idx];
        const double dt = _ptr_array_defaultclock_dt[0];
        ...
        _ptr_array_neurongroup_8_X[_idx] = X;
        _ptr_array_neurongroup_8_Y[_idx] = Y;
...
void _run_neurongroup_8_stateupdater_codeobject_6()
{
    using namespace brian;
    ...
    if (first_run)
    {
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxPotentialBlockSize(&min_num_threads, &num_threads,
                    _run_kernel_neurongroup_8_stateupdater_codeobject_6, 0, 0)  // last args: dynamicSMemSize, blockSizeLimit
                );
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxActiveBlocksPerMultiprocessor(&max_active_blocks,
                    _run_kernel_neurongroup_8_stateupdater_codeobject_6, num_threads, needed_shared_memory)
                );
        ...
        CUDA_SAFE_CALL(
                cudaFuncGetAttributes(&funcAttrib, _run_kernel_neurongroup_8_stateupdater_codeobject_6)
                );
        ...
        {
            printf("INFO _run_kernel_neurongroup_8_stateupdater_codeobject_6\n"
                   "\t%u blocks\n"
                   "\t%u threads\n"
    ...
    _run_kernel_neurongroup_8_stateupdater_codeobject_6<<<num_blocks, num_threads>>>(
            _N,
            num_threads,
            ///// HOST_PARAMETERS /////
            dev_array_neurongroup_8_A,
			dev_array_neurongroup_8_Iexc,
			dev_array_neurongroup_8_Iinh,
			dev_array_neurongroup_8_X,
			dev_array_neurongroup_8_Y,
			_array_defaultclock_dt[0],
			dev_array_neurongroup_8_v
        );

    CUDA_CHECK_ERROR("_run_kernel_neurongroup_8_stateupdater_codeobject_6");
