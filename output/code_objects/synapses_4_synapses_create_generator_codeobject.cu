...
namespace {
    ...
    #define _rand(vectorisation_idx) (_ptr_array_synapses_4_synapses_create_generator_codeobject_rand[vectorisation_idx])
...
// NOTE: _ptr_array_synapses_4_synapses_create_generator_codeobject_rand is NOT an array
...
CurandBuffer<randomNumber_t> _ptr_array_synapses_4_synapses_create_generator_codeobject_rand(&brian::curand_generator, RAND);
randomNumber_t _host_rand(const int _vectorisation_idx)
{
    return _ptr_array_synapses_4_synapses_create_generator_codeobject_rand[_vectorisation_idx];
}

CurandBuffer<randomNumber_t> _ptr_array_synapses_4_synapses_create_generator_codeobject_randn(&brian::curand_generator, RANDN);
randomNumber_t _host_randn(const int _vectorisation_idx)
{
    return _ptr_array_synapses_4_synapses_create_generator_codeobject_randn[_vectorisation_idx];
}
...
size_t used_device_memory_start = used_device_memory;
    ...
    ///// HOST_CONSTANTS ///////////
    const int _numN = 1;
		int32_t* const _array_synapses_4_N_incoming = thrust::raw_pointer_cast(&_dynamic_array_synapses_4_N_incoming[0]);
		const int _numN_incoming = _dynamic_array_synapses_4_N_incoming.size();
		int32_t* const _array_synapses_4_N_outgoing = thrust::raw_pointer_cast(&_dynamic_array_synapses_4_N_outgoing[0]);
		...
		int32_t* const _array_synapses_4__synaptic_post = thrust::raw_pointer_cast(&_dynamic_array_synapses_4__synaptic_post[0]);
		const int _num_synaptic_post = _dynamic_array_synapses_4__synaptic_post.size();
		int32_t* const _array_synapses_4__synaptic_pre = thrust::raw_pointer_cast(&_dynamic_array_synapses_4__synaptic_pre[0]);
    ...
    const int32_t newsize = _dynamic_array_synapses_4__synaptic_pre.size();
            ...
            THRUST_CHECK_ERROR(
                    dev_dynamic_array_synapses_4_w.resize(newsize)
                    );
...
_ptr_array_synapses_4_synapses_create_generator_codeobject_rand.free_memory();
_ptr_array_synapses_4_synapses_create_generator_codeobject_randn.free_memory();
