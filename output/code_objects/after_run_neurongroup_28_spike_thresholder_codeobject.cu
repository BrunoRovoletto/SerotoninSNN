...
void _after_run_neurongroup_28_spike_thresholder_codeobject()
{
...
CUDA_SAFE_CALL(
        cudaOccupancyMaxPotentialBlockSize(&min_num_threads, &num_threads,
            _reset_neurongroup_28_spike_thresholder_codeobject, 0, 0)  // last args: dynamicSMemSize, blockSizeLimit
        );
