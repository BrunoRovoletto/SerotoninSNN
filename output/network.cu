...
void Network::run(const double duration, void (*report_func)(const double, const double, const double, const double), const double report_period)
{
    ...
    while(clock && clock->running())
    {
        ...
        brian::current_idx_array_neurongroup_10__spikespace = (brian::current_idx_array_neurongroup_10__spikespace + 1) % brian::dev_array_neurongroup_10__spikespace.size();
        brian::current_idx_array_neurongroup_11__spikespace = (brian::current_idx_array_neurongroup_11__spikespace + 1) % brian::dev_array_neurongroup_11__spikespace.size();
        ...
        brian::current_idx_array_neurongroup_2__spikespace = (brian::current_idx_array_neurongroup_2__spikespace + 1) % brian::dev_array_neurongroup_2__spikespace.size();
        brian::current_idx_array_neurongroup_3__spikespace = (brian::current_idx_array_neurongroup_3__spikespace + 1) % brian::dev_array_neurongroup_3__spikespace.size();
        brian::current_idx_array_neurongroup_4__spikespace = (brian::current_idx_array_neurongroup_4__spikespace + 1) % brian::dev_array_neurongroup_4__spikespace.size();
        brian::current_idx_array_neurongroup_5__spikespace = (brian::current_idx_array_neurongroup_5__spikespace + 1) % brian::dev_array_neurongroup_5__spikespace.size();
        brian::current_idx_array_neurongroup_6__spikespace = (brian::current_idx_array_neurongroup_6__spikespace + 1) % brian::dev_array_neurongroup_6__spikespace.size();
        brian::current_idx_array_neurongroup_7__spikespace = (brian::current_idx_array_neurongroup_7__spikespace + 1) % brian::dev_array_neurongroup_7__spikespace.size();
        brian::current_idx_array_neurongroup_8__spikespace = (brian::current_idx_array_neurongroup_8__spikespace + 1) % brian::dev_array_neurongroup_8__spikespace.size();
        brian::current_idx_array_neurongroup_9__spikespace = (brian::current_idx_array_neurongroup_9__spikespace + 1) % brian::dev_array_neurongroup_9__spikespace.size();
